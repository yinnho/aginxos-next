...
drv "ls /var/bin/aginxbrowser /var/bin/python3 /var/bin/codex /var/bin/dup /var/bin/aginx-web /var/bin/agf /var/bin/agmem /var/bin/aginx-web.aginxmd"
expect_rc "provision 回面：7 core 件全在（codex 含）+ web face sidecar"
...
drv "ls /var/lib/aginx/stamps/aginxbrowser /var/lib/aginx/stamps/python3 /var/lib/aginx/stamps/aginx-web"
